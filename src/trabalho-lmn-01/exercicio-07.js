...
// Os componentes de seleção de texto são muito importantes para que o usuário final possa
//  selecionar dados para uma pesquisa,
//  por exemplo.
// Suponha que você esteja fornecendo uma lista de Imobiliárias para serem exibidas e 
// que o usuário final possa selecionar uma
// e listar os imóveis disponíveis nela.
// A lista é essa aqui:
// const imobiliarias = ["Arantes", "Terra Nova", "Ivan", "Seratto", "Azaleia"];

// Agora você tem que sempre trazer o nome da primeira imobiliaria, para ela ficar 
// selecionada por default no nosso dropdown.
...
console.log(primeiraImobiliaria);
